...
<img src="~assets/images/loading.gif" alt="">
        ...
        <section class="container m-auto" v-else>
            <div class="text-center">
                <h1 class="text-3xl text-white text-center font-bold p-4">Welcome to Anamikacrew</h1> 
                <div class="mb-3">
                <label for="" class="from-label text-white text-center text-2xl">Select Category</label>
                <select
                class="from-select from-select-lg bg-yellow-950 text-white w-full h-10 border border-indigo-200 text-center"
                v-model="name"
                @change="getUrl(name)">
        ...
        <option
         ...
         {{ category.strCategory }}
            ...
            <div class="container m-auto grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 sm:px-4 sm:ms-4 gap-2 ">
